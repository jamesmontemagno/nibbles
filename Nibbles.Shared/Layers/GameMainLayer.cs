...
namespace Nibbles.Shared.Layers
{
    public class GameMainLayer : CCLayerGradient
    {
        ...
        void OnTouchesMoved(List<CCTouch> touches, CCEvent touchEvent)
        {
            ...
            line.DrawLine(lastPoint, touch.Location, 3, hitBubble.ColorF);
            lastPoint = touch.Location;
        ...
        void EndGame()
        {
            ...
            var gameOverScene = GameOverLayer.CreateScene(GameAppDelegate.GameView, currentScore);
