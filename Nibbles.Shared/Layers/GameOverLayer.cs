...
namespace Nibbles.Shared.Layers
{
    public class GameOverLayer : CCLayerColor
    {
        ...
        public GameOverLayer(Int64 score)
        {
            ...
            touchListener.OnTouchesBegan = (touches, ccevent) =>
            {
                ...
                if (touches[0].Location.X < VisibleBoundsWorldspace.Size.Center.X)
                    GameAppDelegate.GameView.Director.ReplaceScene(GameStartLayer.CreateScene(GameAppDelegate.GameView));
                else
                    GameAppDelegate.GameView.Director.ReplaceScene(GameMainLayer.CreateScene(GameAppDelegate.GameView));
            };
        ...
        public static CCScene CreateScene(CCGameView mainWindow, Int64 score)
        {
