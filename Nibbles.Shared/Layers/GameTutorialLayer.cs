...
namespace Nibbles.Shared.Layers
{
    public class GameTutorialLayer : CCLayerColor
    {
        ...
        public GameTutorialLayer(bool startGameAfter) : base()
        {
            ...
            touchListener.OnTouchesEnded = (touches, ccevent) =>
            {
                ...
                if (currentTutorial >= tutorials.Length)
                {
                    ...
                    if (startGameAfter)
                    {
                        var mainGame = GameMainLayer.CreateScene(GameAppDelegate.GameView);
                    ...
                    {
                        var mainGame = GameStartLayer.CreateScene(GameAppDelegate.GameView);
        ...
        protected override void AddedToScene()
        {
            ...
            title = new CCLabel(string.Empty, GameAppDelegate.MainFont, 36, CCLabelFormat.SystemFont)
            {
            ...
            next = new CCLabel("NEXT", GameAppDelegate.MainFont, 36, CCLabelFormat.SystemFont)
            {
                Color = textColor,
            ...
            message = new CCLabel(string.Empty, GameAppDelegate.MainFont, 48, CCLabelFormat.SystemFont)
            {
        ...
        public static CCScene CreateScene(CCGameView mainWindow, bool startGameAfter = false)
        {
